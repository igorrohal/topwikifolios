...
public class GDriveClientV3 {
    ...
    public static Credential authorize() throws IOException {
        // Load client secrets.
        InputStream in =
                GDriveClientV3.class.getResourceAsStream("/client_credentials.json");
...
//        fileMetadata.setTitle("Topwikifolioss");
...
//        File fileMetadata = new File();
//        fileMetadata.setTitle("uploaded_sample_file.csv");
//        String folderId = "1WNC7d4Km0KizlOUjVcAHHBcjoMGMM_dy";
//        ParentReference folder = new ParentReference();
//        folder.setId(folderId);
//        fileMetadata.setParents(Collections.singletonList(folder));
//
//        String uploadFilePath = "./sample_csv/topwikifolios.csv";
//        java.io.File uploadFile = new java.io.File(uploadFilePath);
//        FileContent mediaContent = new FileContent("text/csv", uploadFile);
//
